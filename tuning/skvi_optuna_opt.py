...
def evaluate(config):
    _experiment = skvi_tuning_wrapper(
        seed=config["seed"],
        env_id=config["env-id"],
        learning_rate=config["learning-rate"],
        number_of_actions=config["number-of-actions"],
        number_of_training_epochs=config["num-epochs"],
...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        "number-of-actions": tune.choice([1, 2, 4]),
        "number-of-train-epochs": tune.choice([1, 2, 4, 8]),
